...
// Resolves a code — any team member's Unique ID, or a YCC Partner /
// Co-Partner's team code / Unique ID — into a roster via
// /api/games/team-lookup, then lets the player pick who's actually playing.
// A single-player roster (an individual registration, or a Partner with no
// Squad attached) skips the dropdown and just shows that one name. The
// resolved selection is handed to the parent game via onSelectionChange so
// it can gate its own Play button and report the eventual win/loss.
