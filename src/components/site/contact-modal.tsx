        ...
        <div className="p-6 pt-4 bg-white">
          <form onSubmit={onSubmit} className="flex flex-col gap-4">
            <div className="grid gap-4 sm:grid-cols-2">
              <div className="flex flex-col gap-1.5">
                ...
                <Input 
                  ...
                  className="bg-white border-gray-200 focus-visible:ring-blue-600 text-gray-900 placeholder:text-gray-400 transition-all shadow-sm"
                />
              </div>
              <div className="flex flex-col gap-1.5">
            ...
            <div className="flex flex-col gap-1.5">
              ...
              <Textarea 
                ...
                rows={3} 
                className="bg-white border-gray-200 focus-visible:ring-blue-600 text-gray-900 placeholder:text-gray-400 resize-none transition-all shadow-sm"
              />
            </div>
            ...
            <Button 
              ...
              className="w-full bg-blue-600 hover:bg-blue-700 text-white font-semibold shadow-md transition-all duration-300"
            >
              {isSubmitting ? (
          ...
          <div className="mt-6 flex flex-col items-center justify-center text-center">
            ...
            <a 
              ...
              className="group inline-flex w-full items-center justify-center rounded-lg bg-green-50 text-green-600 hover:bg-green-100 hover:text-green-700 border border-green-200 shadow-sm transition-all duration-300 h-11 px-6 font-semibold gap-2.5"
            >
