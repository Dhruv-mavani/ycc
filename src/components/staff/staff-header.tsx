  ...
  return (
    <header className="bg-background sticky top-0 z-10 flex items-center justify-between border-b px-4 py-3">
      <div className="flex items-center gap-2">
        <BackButton fallbackHref="/staff" label="" className="mr-1 h-8 w-8 p-0 sm:w-auto sm:px-3 sm:py-2" />
        <Link href="/staff" className="flex items-center gap-2">
          ...
          />
          <span className="hidden min-[360px]:inline text-sm font-semibold">Staff Booth</span>
        </Link>
      </div>
      <div className="flex items-center gap-2">
