...
import {
  individualFreeCertificateLookupSchema,
  type IndividualFreeCertificateLookupInput,
} from "@/lib/validations/registration";

export default function MoneyHeistCertificateLookupPage() {
  ...
  } = useForm<IndividualFreeCertificateLookupInput>({
    resolver: zodResolver(individualFreeCertificateLookupSchema),
    defaultValues: { query: "" },
  });

  async function onSubmit(values: IndividualFreeCertificateLookupInput) {
    setFormError(null);
    try {
      const res = await fetch("/api/individual-free-registrations/certificate/lookup", {
        method: "POST",
      ...
      window.location.assign(
        `/api/individual-free-registrations/${data.registrationId}/certificate`,
      );
    } catch {
          ...
          <CardContent className="px-6 sm:px-10 py-8">
            ...
            <div className="space-y-1.5">
              ...
              <Input
                ...
                placeholder="9876543210 or DHRU9825"
